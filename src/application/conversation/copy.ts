...
export const CALLBACK_HOURS_DASH =
...
export const CALLBACK_HOURS_COLON =
  'Мы работаем в будни с 8-00 до 18-00  в рабочие дни пн-пт по Москве.В начала рабочего времени, у нас будут данные какие машины будут свободные под Ваш груз.И сориентировать Вас по стоимости.';
...
export const ESTIMATE_WAITING_THANKS_REPLY =
  'Пожалуйста, пишите если появятся вопросы.';
...
export const ESTIMATE_DIFFICULTY_PHONE_REPLY =
